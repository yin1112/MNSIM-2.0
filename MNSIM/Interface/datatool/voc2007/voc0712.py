...
import numpy as np
import random
from utils.voc2007.augmentations import SSDAugmentation
from datatool.voc2007 import *
...
def get_dataloader():
    flag = os.system("sh script/VOC2007.sh")
    assert flag == 0 
    train_dataset = VOCDetection(
                        img_size=cfg.voc.TRAIN_SIZE[0],
                        transform=SSDAugmentation(cfg.voc.TRAIN_SIZE)
                        )
    test_dataset = VOCDetection(
                                    img_size=cfg.voc.VAL_SIZE[0],
...
if __name__ == "__main__":
    ...
    img_size = 640
    # dataset
    dataset = VOCDetection(cfg.voc.root, img_size, [('2007', 'trainval')],
