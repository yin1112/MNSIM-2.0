...
from datatool.voc2007.voc0712 import VOCDetection
import sys
import os
import time
import numpy as np
...
class VOCAPIEvaluator():
    ...
    def __init__(self, dataset,data_root , img_size, device, transform, labelmap, set_type='test', year='2007', display=False):
    ...
    def evaluate(self, net,MODE):
        ...
        for i in range(num_images):
            ...
            t0 = time.time()
            # forward
            bboxes, scores, cls_inds = net(x ,MODE)
